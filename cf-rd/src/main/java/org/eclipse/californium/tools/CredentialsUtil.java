...
public class CredentialsUtil {
	 ...
	 */
	public static final List<Mode> DEFAULT_CLIENT_MODES = Arrays.asList(new Mode[] { Mode.PSK });
	 ...
	 */
	public static final List<Mode> DEFAULT_SERVER_MODES = Arrays.asList(new Mode[] { Mode.PSK, Mode.ECDHE_PSK });

	// from ETSI Plugtest test spec
	public static final String PSK_IDENTITY = "RIOTer";
	public static final byte[] PSK_SECRET = "LGPLisyourfriend".getBytes();
